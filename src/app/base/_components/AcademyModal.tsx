...
import TrainModal from "@/app/base/_components/TrainModal.tsx";
...
export default function AcademyModal()
{
    ...
    return (
        <>
            <button onClick={() => setIsOpen(true)} className="button w-1/3 h-40 flex justify-around items-center">
                Academy
            </button>
            ...
            <Dialog open={isOpen} onClose={() => setIsOpen(false)} className="relative z-50">
                ...
                <div className="fixed inset-0 flex w-screen items-center justify-center">
                    ...
                    <DialogPanel className="w-full flex flex-col items-center space-y-4 border bg-black p-5 relative pb-10">
                        ...
                        <div className="flex flex-row justify-between items-center w-full h-35 my-5">

                            <TrainModal />

                            <button className="flex flex-col justify-between items-center w-1/2 h-35 border-1 p-2 m-2">
                                <div className="w-full text-left">Time Remaining:</div>
                                <div className="flex flex-row justify-between items-center w-full h-20">
                                    <div className="border-1 rounded-full w-20 h-20 flex flex-row justify-around items-center">Clock <br/>Icon</div>
                                    <div>No train.</div>
                                </div>
                                <div className="flex flex-row justify-start items-center w-full h-10 mt-2">
                                </div>
                            </button>

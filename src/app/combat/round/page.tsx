    ...
    return (
        ...
        <div className="flex flex-col items-center justify-start h-screen w-full">
            ...
            <div className="w-full flex flex-row items-center justify-between py-5">
                <button className="button w-1/2 h-10 inline-block">Health Points 20/50</button>
                <button className="button w-1/2 h-10 inline-block">Enemy HP 130/200</button>
            </div>
            ...
            <div className="w-full flex flex-row items-center justify-between">
                ...
                <div className="w-2/3 flex flex-col items-center justify-between pl-3">
                    ...
                    <div className="w-full flex flex-row items-center justify-around py-2">
                        ...
                        <button className="button w-10 h-10 rounded-full m-[2px!important]">1</button>
                        <button className="button w-10 h-10 rounded-full m-[2px!important]">2</button>
                        <button className="button w-10 h-10 rounded-full m-[2px!important]">3</button>
                        <button className="button w-10 h-10 rounded-full m-[2px!important]">4</button>
                    </div>

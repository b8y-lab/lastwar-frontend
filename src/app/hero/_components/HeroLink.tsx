...
export default function HeroLink({
  ...
  if (isEmpty) {
    return (
      <div
        className="flex flex-col items-center justify-center relative w-[120px] aspect-[130/202]"
        style={{
  ...
  return (
    <Link href={url + '?hid=' + id + '&mid=' + mid}>
      <div
        className="flex flex-col items-center justify-start relative w-[120px] aspect-[130/202]"
        style={{
      ...
      >
        ...
        <div
          className="mt-6 w-[100px] aspect-[100/120] mx-auto"
          style={{
        ...
        <div
          className="absolute bottom-[6px] left-[6px] w-[105px] aspect-[212/90]"
          style={{

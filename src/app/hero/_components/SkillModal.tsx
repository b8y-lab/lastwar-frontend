...
export default function SkillModal  ()
{
    ...
    return (
        <>
            <button onClick={() => setIsOpen(true)} className="button w-1/2 h-35 flex items-center justify-around">
                Skill
            </button>
                ...
                <div className="fixed inset-0 flex w-screen items-center justify-center p-2">
                    ...
                    <DialogPanel className="w-full flex flex-col items-center  space-y-4 border bg-black p-5 relative pb-10">
                        ...
                        <div className="w-full flex flex-row items-center justify-between">
                            ...
                            <button className="button w-1/2 h-55 ml-[0!important]">Skill<br/>Icon</button>

                            <div className="w-1/2 items-center justify-between ">
                                <button className="button w-full h-10 mx-[0!important]">Skill Level</button>
                                <button className="button w-full h-10 mx-[0!important]">Refresh</button>
                                <button className="button w-full h-10 mx-[0!important]">Type</button>
                                <button className="button w-full h-10 mx-[0!important]">Applied to</button>
                            </div>

                ...
                <div className="fixed inset-0 flex w-screen items-center justify-center p-5">
                    ...
                    <DialogPanel className="w-full space-y-4 border bg-black p-5 relative pb-10">
                        ...
                        <div className="w-full flex flex-row items-center justify-between">
                            <button className="button w-1/3 h-30 flex items-center justify-around">On</button>
                            <button className="button w-1/3 h-30 flex items-center justify-around">Off</button>
                        </div>
